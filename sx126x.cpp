...
bool sx126x::preInit() {
  ...
  #if BOARD_MODEL == BOARD_T3S3 || BOARD_MODEL == BOARD_HELTEC32_V3 || BOARD_MODEL == BOARD_HELTEC32_V4 || BOARD_MODEL == BOARD_TDECK || BOARD_MODEL == BOARD_XIAO_S3 || BOARD_MODEL == BOARD_RETIA_NIBBLE_CONNECT || BOARD_MODEL == BOARD_RETIA_NIBBLE_SCONNECT || BOARD_MODEL == BOARD_RETIA_NEWSHEEN
...
void sx126x::enableTCXO() {
      ...
      uint8_t buf[4] = {MODE_TCXO_1_8V_6X, 0x00, 0x00, 0xFF};
    #elif BOARD_MODEL == BOARD_RETIA_NIBBLE || BOARD_MODEL == BOARD_RETIA_NIBBLE_CONNECT || BOARD_MODEL == BOARD_RETIA_NIBBLE_SCONNECT || BOARD_MODEL == BOARD_RETIA_NEWSHEEN
      uint8_t buf[4] = {MODE_TCXO_1_8V_6X, 0x00, 0x00, 0xFF};
    #endif
